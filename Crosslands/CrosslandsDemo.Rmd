...
renderPlotly({
  if(input$Var == "Depth"){
    ...
    plotly_p <- plot_ly(data=wdepth, x=~datetime, y=~Depth, mode='line+markers', marker=list(color='rgb(84,153,199)'),line=list(color='rgba(179,179,179,0.5)',dash='dash')) %>%
      toWebGL()
    plotly_p
...
**<span style="color:#5499C7">Measurements:</span>** `r dim(cache_wdepth)` <br><br>
...
<span style="color:#ededed;align="left">Version 1.0</span>
